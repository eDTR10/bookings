import{u as q,r as c,j as e,M as S,a as y,S as k}from"./index-d03597bb.js";import{A}from"./arrow-left-31c9f273.js";import{F as T}from"./file-text-c44de54a.js";import{D as z,C as P}from"./download-1aabe7e1.js";import{C as $}from"./check-circle-2-9e39efef.js";import{X as L}from"./x-circle-64b23d82.js";const l=a=>String(a??"").replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;").replace(/'/g,"&#039;"),_=a=>{if(!a)return"—";const s=new Date(`${a}T00:00:00`);return Number.isNaN(s.getTime())?a:s.toLocaleDateString("en-US",{year:"numeric",month:"long",day:"numeric"})};function O(a,s,o){const f=s.length>0?s.map(t=>`
              <tr>
