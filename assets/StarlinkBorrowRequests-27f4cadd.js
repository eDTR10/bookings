import{u as q,r as c,j as e,M as S,a as y,S as k}from"./index-43cb9c89.js";import{A}from"./arrow-left-a410c471.js";import{F as T}from"./file-text-c24f2d2d.js";import{D as z,C as P}from"./download-c238535b.js";import{C as $}from"./check-circle-2-eb8737f2.js";import{X as L}from"./x-circle-c8b9202b.js";const l=a=>String(a??"").replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;").replace(/'/g,"&#039;"),_=a=>{if(!a)return"—";const s=new Date(`${a}T00:00:00`);return Number.isNaN(s.getTime())?a:s.toLocaleDateString("en-US",{year:"numeric",month:"long",day:"numeric"})};function O(a,s,o){const f=s.length>0?s.map(t=>`
              <tr>
