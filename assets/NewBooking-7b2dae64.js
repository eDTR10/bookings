import{i as fe,u as xe,d as ge,r as d,a as G,j as e,M as ve,A as I,S as y}from"./index-caf7588b.js";import{S as J}from"./react-select.esm-deb50b88.js";import"./defineProperty-2a4504bf.js";import"./slicedToArray-92ea9758.js";const c=({path:g,size:b=18})=>e.jsx("svg",{width:b,height:b,viewBox:"0 0 24 24",fill:"none",stroke:"currentColor",strokeWidth:1.8,strokeLinecap:"round",strokeLinejoin:"round",children:e.jsx("path",{d:g})}),l={office:"M4 21V7l8-4 8 4v14M9 21v-6h6v6M4 21h16M9 10h.01M15 10h.01M9 14h.01M15 14h.01",room:"M5 21V4a1 1 0 0 1 1-1h8l5 5v13H5Z M14 3v5h5 M9 12h6",calendar:"M8 2v4M16 2v4M3.5 9h17M4 5h16a1 1 0 0 1 1 1v14a1 1 0 0 1-1 1H4a1 1 0 0 1-1-1V6a1 1 0 0 1 1-1Z",clock:"M12 21a9 9 0 1 0 0-18 9 9 0 0 0 0 18ZM12 7v5l3.5 2",laptop:"M4 5h16v10H4z M2 19h20 M9 15h6",computer:"M4 4h16v11H4z M9 20h6 M12 15v5",table:"M3 8h18 M6 8v11 M18 8v11 M3 8l2-4h14l2 4",projector:"M3 15a4 4 0 1 0 8 0 4 4 0 0 0-8 0ZM15 10h6v8h-6zM7 11V6a1 1 0 0 1 1-1h3",box:"M21 8 12 3 3 8v8l9 5 9-5V8ZM3 8l9 5 9-5M12 13v8",upload:"M12 16V4M7 9l5-5 5 5M4 20h16",file:"M14 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V8z M14 2v6h6",user:"M12 12a4 4 0 1 0 0-8 4 4 0 0 0 0 8ZM4 21a8 8 0 0 1 16 0",mail:"M4 5h16a1 1 0 0 1 1 1v12a1 1 0 0 1-1 1H4a1 1 0 0 1-1-1V6a1 1 0 0 1 1-1ZM3 6l9 7 9-7",phone:"M6.6 10.8a15.5 15.5 0 0 0 6.6 6.6l2.2-2.2a1 1 0 0 1 1-.24 11 11 0 0 0 3.4.55 1 1 0 0 1 1 1V20a1 1 0 0 1-1 1A17 17 0 0 1 3 4a1 1 0 0 1 1-1h3.5a1 1 0 0 1 1 1 11 11 0 0 0 .55 3.4 1 1 0 0 1-.25 1Z",arrowLeft:"M19 12H5M12 19l-7-7 7-7",arrowRight:"M5 12h14M12 5l7 7-7 7",check:"M20 6 9 17l-5-5",checkSquare:"M9 11l3 3L22 4 M21 12v7a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2V5a2 2 0 0 1 2-2h11",alert:"M12 9v4M12 17h.01M10.3 3.9 1.8 18a2 2 0 0 0 1.7 3h17a2 2 0 0 0 1.7-3L13.7 3.9a2 2 0 0 0-3.4 0Z",lock:"M6 11V7a6 6 0 0 1 12 0v4M5 11h14v10H5z",minus:"M5 12h14",plus:"M12 5v14M5 12h14",search:"M11 19a8 8 0 1 0 0-16 8 8 0 0 0 0 16ZM21 21l-4.35-4.35"},ye=g=>{const b=(g||"").toLowerCase();return b.includes("laptop")?l.laptop:b.includes("computer")||b.includes("pc")||b.includes("desktop")?l.computer:b.includes("table")?l.table:b.includes("projector")?l.projector:l.box},P=g=>({control:b=>`nb-rs-control${b.isFocused?" focused":""}${g?" err":""}${b.isDisabled?" disabled":""}`,valueContainer:()=>"nb-rs-value-container",placeholder:()=>"nb-rs-placeholder",singleValue:()=>"nb-rs-single-value",input:()=>"nb-rs-input",indicatorsContainer:()=>"nb-rs-indicators",indicatorSeparator:()=>"nb-rs-hide",dropdownIndicator:()=>"nb-rs-dropdown-indicator",clearIndicator:()=>"nb-rs-clear-indicator",menu:()=>"nb-rs-menu",menuList:()=>"nb-rs-menu-list",option:b=>`nb-rs-option${b.isFocused?" focused":""}${b.isSelected?" selected":""}`,noOptionsMessage:()=>"nb-rs-no-options"}),W=[{id:1,title:"Location & Schedule",subtitle:"Reserve a space and equipment for your event. Start with the venue and time."},{id:2,title:"Equipment & Resources",subtitle:"Request available equipment for your reservation."},{id:3,title:"Request Details",subtitle:"Purpose and goals of your request."},{id:4,title:"Contact Information",subtitle:"Requestor verification and details."}],R=8,je=g=>{if(typeof g!="string"||!g.trim())return"";const b=g.trim();try{const j=new URL(b,I);return["localhost","127.0.0.1","0.0.0.0"].includes(j.hostname)&&(j.protocol=new URL(I).protocol,j.host=new URL(I).host),j.toString()}catch{return b}};function Ee({offices:g,bookings:b=[],prefilledData:j,onAdd:K,onCancel:ee}){const $=fe(),ne=xe(),z=ge(),N=g??(z==null?void 0:z.offices)??[],o=d.useMemo(()=>{var i;const n=((i=$.state)==null?void 0:i.prefilledData)||j;if(!n)return n;const a=N.find(t=>String(t.id)===String(n.venue)||String(t.id)===String(n.officeId)||String(t.office_name??t.name)===String(n.venue));return a?{...n,venue:a.office_name??a.name??"",office:a.id}:n},[$.state,j,N]),[r,m]=d.useState({venue:o!=null&&o.venue&&o.venue!=="All"?o.venue:"",facility:o!=null&&o.facility&&o.facility!=="All"?o.facility:"",date:(o==null?void 0:o.date)||"",startTime:(o==null?void 0:o.startTime)||"",endTime:(o==null?void 0:o.endTime)||"",purpose:"",activityName:(o==null?void 0:o.activityName)||"",requestor:"",email:"",phoneNumber:"",selectedEquipment:[],attachmentName:"",attachment:null,office:(o==null?void 0:o.office)??(o==null?void 0:o.officeId)??"",equipmentQuantities:{}});d.useEffect(()=>{o&&o.venue&&o.venue!==r.venue&&m(n=>({...n,venue:o.venue,office:o.office??o.officeId??n.office,facility:o.facility??n.facility,date:o.date??n.date,startTime:o.startTime??n.startTime,endTime:o.endTime??n.endTime,activityName:o.activityName??n.activityName}))},[o]);const[L,re]=d.useState([]),[F,B]=d.useState(null),[f,O]=d.useState(1),[Q,V]=d.useState(!1),[v,E]=d.useState({}),[A,_]=d.useState(""),[S,H]=d.useState("All"),T="dict_booking_form_data";d.useEffect(()=>{const n=localStorage.getItem(T);if(n)try{const a=JSON.parse(n);m(i=>({...i,...a,attachment:null,attachmentName:""}))}catch(a){console.error("Error loading persisted form data:",a)}},[]),d.useEffect(()=>{const{attachment:n,attachmentName:a,...i}=r;Object.values(i).some(t=>t!==""&&(Array.isArray(t)?t.length>0:!0))&&localStorage.setItem(T,JSON.stringify(i))},[r]),d.useEffect(()=>{G.get("inventory/").then(n=>re(n.data)).catch(n=>console.error("Error fetching inventory:",n))},[]),d.useEffect(()=>{_(""),H("All"),V(!1)},[r.venue]);const u=d.useMemo(()=>N.find(n=>String(n.office_name??n.name)===String(r.venue)||String(n.id)===String(r.office)),[r.venue,r.office,N]),w=d.useMemo(()=>r.venue?L.filter(n=>{const a=String(n.venue??"")===String(r.venue),i=r.office&&n.office!=null?String(n.office)===String(r.office):!0;return a&&i&&Number(n.available)>0}):[],[r.venue,L]),te=d.useMemo(()=>["All",...Array.from(new Set(w.map(a=>a.name)))],[w]),q=d.useMemo(()=>{const n=A.trim().toLowerCase();return w.filter(a=>{const i=S==="All"||a.name===S,t=!n||String(a.name??"").toLowerCase().includes(n);return i&&t})},[w,S,A]),ae=Q?q:q.slice(0,R),ie=n=>{var a;return((a=r.selectedEquipment.find(i=>i.id===n))==null?void 0:a.requestedQty)||0},U=!!(r.venue&&r.facility&&r.date&&r.startTime&&r.endTime),D=d.useMemo(()=>N.map(n=>({value:String(n.office_name??n.name??""),label:n.office_name??n.name??"",raw:n})),[N]),oe=d.useMemo(()=>D.find(n=>n.value===String(r.venue))??null,[D,r.venue]),M=d.useMemo(()=>((u==null?void 0:u.rooms)??[]).map(n=>({value:n.name,label:n.name,raw:n})),[u]),se=d.useMemo(()=>M.find(n=>n.value===String(r.facility))??null,[M,r.facility]),le=n=>{var a;m({...r,venue:(n==null?void 0:n.value)??"",office:((a=n==null?void 0:n.raw)==null?void 0:a.id)??"",facility:"",selectedEquipment:[],equipmentQuantities:{}})},ce=n=>{m({...r,facility:(n==null?void 0:n.value)??""})},de=n=>{const a=new Date;if(a.setHours(0,0,0,0),new Date(n)<a){y.fire({icon:"warning",title:"Invalid Date",text:"You cannot select a past date.",confirmButtonColor:"#2F6FED"}),B("You cannot select a past date."),m({...r,date:""});return}if(b.filter(s=>s.date===n&&s.venue===r.venue&&s.facility===r.facility&&s.status!=="REJECTED"&&s.status!=="CANCELLED").length>=3){y.fire({icon:"error",title:"Facility Fully Booked",text:"This facility is fully booked for the selected date. Please choose another date or venue.",confirmButtonColor:"#E23D3D"}),B("This facility is fully booked for the selected date. Please choose another date or venue."),m({...r,date:""});return}B(null),m({...r,date:n})},Z=(n,a)=>{m(i=>{const t=i.selectedEquipment.find(x=>x.id===n.id),s=(t==null?void 0:t.requestedQty)||0,p=Math.max(0,Math.min(n.available,s+a));let h;return p===0?h=i.selectedEquipment.filter(x=>x.id!==n.id):t?h=i.selectedEquipment.map(x=>x.id===n.id?{...x,requestedQty:p}:x):h=[...i.selectedEquipment,{...n,requestedQty:p}],{...i,selectedEquipment:h,equipmentQuantities:h.reduce((x,k)=>(x[String(k.id)]=Number(k.requestedQty)||0,x),{})}})},pe=n=>{var i;const a=(i=n.target.files)==null?void 0:i[0];if(a){if(a.size>10*1024*1024){y.fire({icon:"error",title:"File Too Large",text:"The request letter must be under 10MB.",confirmButtonColor:"#E23D3D"}),n.target.value="";return}m(t=>({...t,attachmentName:a.name,attachment:a}))}},X=(n,a=!0)=>{const i={},t=[];if(n===1&&(r.venue||(i.venue=!0,t.push("Regional Office")),r.facility||(i.facility=!0,t.push("Room / Unit")),r.date||(i.date=!0,t.push("Reservation Date")),r.startTime||(i.startTime=!0,t.push("Start Time")),r.endTime||(i.endTime=!0,t.push("End Time")),r.startTime&&r.endTime&&r.endTime<=r.startTime))return i.endTime=!0,E(i),y.fire({icon:"warning",title:"Check the Schedule",text:"End time must be after start time.",confirmButtonColor:"#2F6FED"}),!1;if(n===3){const s=String(r.purpose??"").trim(),p=String(r.activityName??"").trim();s||(i.purpose=!0,t.push("Purpose / Objectives")),p||(i.activityName=!0,t.push("Name of Activity"))}if(n===4){const s=String(r.requestor??"").trim(),p=String(r.email??""),h=String(r.phoneNumber??"");s||(i.requestor=!0,t.push("Requestor Full Name")),/^\S+@\S+\.\S+$/.test(p)||(i.email=!0,t.push("Email Address (must be a valid email)")),h.length<10&&(i.phoneNumber=!0,t.push("Contact Number (at least 10 digits)"))}return E(i),a&&Object.keys(i).length>0?(y.fire({icon:"warning",title:"Missing Information",html:`Please complete the following before continuing:<br/><strong>${t.join(", ")}</strong>`,confirmButtonColor:"#2F6FED"}),!1):!0},be=()=>{f===1&&!X(1,!1)||(E({}),O(n=>Math.min(4,n+1)))},ue=()=>{if(f===1){ee();return}E({}),O(n=>Math.max(1,n-1))},me=()=>{if(!X(4))return;const a=(t=>{const s={...t};return delete s.id,delete s.createdAt,s.status="PENDING",s.region=(u==null?void 0:u.region)||"",s.office=(u==null?void 0:u.id)??s.office??"",s.venue=(u==null?void 0:u.office_name)??(u==null?void 0:u.name)??s.venue??"",s.selectedEquipment=Array.isArray(s.selectedEquipment)?s.selectedEquipment:[],s.equipmentQuantities=s.selectedEquipment.reduce((p,h)=>(p[String(h.id)]=Number(h.requestedQty)||0,p),{}),s})(r),i=new FormData;Object.keys(a).forEach(t=>{t==="selectedEquipment"||t==="equipmentQuantities"?i.append(t,JSON.stringify(a[t])):t==="attachment"?a[t]instanceof File&&i.append(t,a[t]):i.append(t,a[t]!==null&&a[t]!==void 0?a[t]:"")}),y.fire({title:"Submitting Request",text:"Please wait while we process your booking...",allowOutsideClick:!1,didOpen:()=>{y.showLoading()}}),G.post("bookings/",i).then(async t=>{const s=t.data;await y.fire({icon:"info",title:"Request Submitted",html:'<p>Your booking request is now <strong>pending admin approval</strong>.</p><p class="mt-2">You will receive an email once the administrator approves, rejects, or cancels your request.</p>',confirmButtonText:"Go to Dashboard",confirmButtonColor:"#2563eb",allowOutsideClick:!1}),localStorage.removeItem(T),K(s),ne("/bookings/portal/dashboard",{replace:!0})}).catch(t=>{const s=t.response;if(s){let p=s.data,h=p.message||"Unknown error occurred.",x=p.details?`
Details: ${p.details}`:"";if(typeof p=="object"&&p!==null&&!p.message){const k=[];for(const[he,C]of Object.entries(p))Array.isArray(C)?k.push(`${he}: ${C[0]}`):typeof C=="string"&&k.push(C);k.length>0&&(h=k.join(`
`))}y.fire({icon:"error",title:"Submission Failed",text:h+x,confirmButtonColor:"#E23D3D"})}else console.error("Booking Error:",t),y.fire({icon:"error",title:"Network Error",text:"Error connecting to the server. Please check your connection and try again.",confirmButtonColor:"#E23D3D"})})},Y=W[f-1];return e.jsxs("div",{className:"nb-page",children:[e.jsx("style",{children:`
            ...
            `}),e.jsxs("div",{className:"nb-shell",children:[e.jsxs("div",{className:"nb-hero",children:[e.jsx("div",{className:"nb-hero-left",children:e.jsx("div",{className:"nb-steps-row",children:W.map(n=>e.jsxs("div",{className:`nb-step-item ${n.id===f?"active":""} ${n.id<f?"done":""}`,children:[e.jsx("div",{className:"nb-step-badge",children:n.id<f?e.jsx(c,{path:l.check,size:15}):String(n.id).padStart(2,"0")}),e.jsx("div",{className:"nb-step-label",children:n.title})]},n.id))})}),e.jsx("div",{className:"nb-hero-right",children:e.jsx(ve,{})})]}),e.jsxs("form",{onSubmit:n=>n.preventDefault(),style:{display:"flex",flexDirection:"column",flex:1},children:[e.jsx("div",{className:"nb-body-outer",children:e.jsxs("div",{className:"nb-body-inner",children:[e.jsx("h1",{className:"nb-title",children:f===1?"Facility request":Y.title}),e.jsx("p",{className:"nb-subtitle",children:Y.subtitle}),f===1&&e.jsxs(e.Fragment,{children:[e.jsxs("div",{className:"nb-row-2",children:[e.jsxs("div",{className:"nb-field",children:[e.jsxs("label",{className:"nb-label",children:[e.jsx(c,{path:l.office}),"Regional office ",e.jsx("span",{className:"req",children:"*"})]}),e.jsx(J,{unstyled:!0,classNamePrefix:"nbrs",classNames:P(v.venue),options:D,value:oe,onChange:le,placeholder:"Select office",isClearable:!0,isSearchable:!0,noOptionsMessage:()=>"No offices found"})]}),e.jsxs("div",{className:"nb-field",children:[e.jsxs("label",{className:"nb-label",children:[e.jsx(c,{path:l.room}),"Room / unit ",e.jsx("span",{className:"req",children:"*"})]}),e.jsx(J,{unstyled:!0,classNamePrefix:"nbrs",classNames:P(v.facility),options:M,value:se,onChange:ce,placeholder:"Select room",isClearable:!0,isSearchable:!0,isDisabled:!u||M.length===0,noOptionsMessage:()=>"No rooms found"})]})]}),e.jsxs("div",{className:"nb-row-3",children:[e.jsxs("div",{className:"nb-field",children:[e.jsxs("label",{className:"nb-label",children:[e.jsx(c,{path:l.calendar}),"Reservation date ",e.jsx("span",{className:"req",children:"*"})]}),e.jsx("input",{type:"date",className:`nb-input ${F||v.date?"err":""}`,value:r.date,onChange:n=>de(n.target.value)})]}),e.jsxs("div",{className:"nb-field",children:[e.jsxs("label",{className:"nb-label",children:[e.jsx(c,{path:l.clock}),"Start time ",e.jsx("span",{className:"req",children:"*"})]}),e.jsx("input",{type:"time",className:`nb-input ${v.startTime?"err":""}`,value:r.startTime,onChange:n=>m({...r,startTime:n.target.value})})]}),e.jsxs("div",{className:"nb-field",children:[e.jsxs("label",{className:"nb-label",children:[e.jsx(c,{path:l.clock}),"End time ",e.jsx("span",{className:"req",children:"*"})]}),e.jsx("input",{type:"time",className:`nb-input ${v.endTime?"err":""}`,value:r.endTime,onChange:n=>m({...r,endTime:n.target.value})})]})]}),F&&e.jsxs("div",{className:"nb-warning",children:[e.jsx(c,{path:l.alert,size:15}),F]}),e.jsxs("div",{className:`nb-hint ${U?"filled":""}`,children:[e.jsx(c,{path:l.checkSquare,size:16}),U?e.jsxs("span",{children:[e.jsx("strong",{children:r.facility})," at ",e.jsx("strong",{children:r.venue})," · ",r.date," · ",r.startTime,"–",r.endTime]}):e.jsx("span",{children:"Fill in the fields above to preview your request."})]})]}),f===2&&e.jsxs(e.Fragment,{children:[r.venue&&w.length>0&&e.jsxs("div",{className:"nb-equip-toolbar",children:[e.jsxs("div",{className:"nb-search",children:[e.jsx(c,{path:l.search,size:16}),e.jsx("input",{type:"text",placeholder:"Search equipment",value:A,onChange:n=>_(n.target.value)})]}),e.jsx("div",{className:"nb-pills",children:te.map(n=>e.jsx("button",{type:"button",className:`nb-pill ${S===n?"active":""}`,onClick:()=>H(n),children:n},n))})]}),e.jsx("div",{className:"nb-equip-grid",children:r.venue?w.length===0?e.jsxs("div",{className:"nb-empty",children:[e.jsx(c,{path:l.box,size:26}),e.jsx("div",{children:"No equipment is available at this venue."})]}):q.length===0?e.jsxs("div",{className:"nb-empty",children:[e.jsx(c,{path:l.search,size:26}),e.jsx("div",{children:"No equipment matches your search."})]}):e.jsxs(e.Fragment,{children:[ae.map(n=>{const a=ie(n.id),i=a>0,t=je(n.image),s=!!t;return e.jsxs("div",{className:`nb-equip-card ${i?"selected":""}`,children:[e.jsxs("div",{className:"nb-equip-top",children:[e.jsxs("div",{className:"nb-equip-thumb",children:[s?e.jsx("img",{src:t,alt:n.name,onError:p=>{var h;p.currentTarget.style.display="none",(h=p.currentTarget.nextElementSibling)==null||h.removeAttribute("hidden")}}):null,e.jsx("div",{className:"nb-equip-icon",hidden:s,children:e.jsx(c,{path:ye(n.name),size:22})})]}),e.jsxs("div",{style:{minWidth:0,flex:1},children:[e.jsx("p",{className:"nb-equip-name",children:n.name}),e.jsx("p",{className:"nb-equip-sub",children:n.category||n.description||"Available equipment"})]})]}),e.jsxs("div",{className:"nb-equip-meta",children:[e.jsxs("div",{className:"nb-equip-meta-item",children:[e.jsx("p",{className:"nb-equip-meta-label",children:"Brand"}),e.jsx("p",{className:"nb-equip-meta-value",children:n.brand||"—"})]}),e.jsxs("div",{className:"nb-equip-meta-item",children:[e.jsx("p",{className:"nb-equip-meta-label",children:"Model"}),e.jsx("p",{className:"nb-equip-meta-value",children:n.model||"—"})]})]}),e.jsxs("div",{className:"nb-equip-bottom",children:[e.jsxs("span",{className:"nb-equip-stock",children:["Stock: ",n.available]}),e.jsxs("div",{className:"nb-stepper",children:[e.jsx("button",{type:"button",disabled:a===0,onClick:()=>Z(n,-1),children:e.jsx(c,{path:l.minus,size:13})}),e.jsx("span",{className:"qty",children:a}),e.jsx("button",{type:"button",className:"primary",disabled:a>=n.available,onClick:()=>Z(n,1),children:e.jsx(c,{path:l.plus,size:13})})]})]})]},n.id)}),q.length>R&&e.jsx("button",{type:"button",className:"nb-more-btn",onClick:()=>V(n=>!n),children:Q?"Show less":`+ ${q.length-R} more equipment`})]}):e.jsxs("div",{className:"nb-empty",children:[e.jsx(c,{path:l.office,size:26}),e.jsx("div",{children:"Select a Regional Office first to see available equipment."})]})}),r.selectedEquipment.length>0&&e.jsxs("div",{className:"nb-summary",children:[e.jsx("p",{className:"nb-summary-title",children:"Selected Equipment"}),r.selectedEquipment.map(n=>e.jsxs("div",{className:"nb-summary-row",children:[e.jsx("span",{children:n.name}),e.jsxs("strong",{children:[n.requestedQty," ",n.requestedQty>1?"pcs":"pc"]})]},n.id))]})]}),f===3&&e.jsxs(e.Fragment,{children:[e.jsxs("div",{className:"nb-field",children:[e.jsxs("label",{className:"nb-label",children:["Name of activity ",e.jsx("span",{className:"req",children:"*"})]}),e.jsx("input",{type:"text",className:`nb-input ${v.activityName?"err":""}`,value:r.activityName,onChange:n=>m({...r,activityName:n.target.value}),placeholder:"e.g. ICT Skills Training for Youth"})]}),e.jsxs("div",{className:"nb-field",children:[e.jsxs("label",{className:"nb-label",children:["Purpose / objectives ",e.jsx("span",{className:"req",children:"*"})]}),e.jsx("textarea",{className:`nb-textarea ${v.purpose?"err":""}`,rows:6,value:r.purpose,onChange:n=>m({...r,purpose:n.target.value}),placeholder:"Describe the purpose and goals of your event..."})]}),e.jsxs("div",{className:"nb-field",children:[e.jsx("label",{className:"nb-label",children:"Formal request letter / document"}),e.jsxs("div",{className:"nb-dropzone",onClick:()=>{var n;return(n=document.getElementById("fileInput"))==null?void 0:n.click()},children:[e.jsx("input",{id:"fileInput",type:"file",onChange:pe,style:{display:"none"},accept:".pdf,.jpg,.jpeg,.png"}),e.jsx("div",{className:"nb-dropzone-icon",children:e.jsx(c,{path:l.lock,size:18})}),e.jsx("p",{className:"nb-dropzone-title",children:"Click to upload request letter"}),e.jsx("p",{className:"nb-dropzone-hint",children:"Support document · PDF / Image · 10MB max"}),r.attachmentName&&e.jsxs("div",{className:"nb-dropzone-file",children:[e.jsx(c,{path:l.check,size:14}),r.attachmentName]})]})]})]}),f===4&&e.jsxs("div",{className:"nb-row-2",children:[e.jsxs("div",{className:"nb-field",style:{gridColumn:"1 / -1"},children:[e.jsxs("label",{className:"nb-label",children:[e.jsx(c,{path:l.user}),"Requestor full name ",e.jsx("span",{className:"req",children:"*"})]}),e.jsx("input",{type:"text",className:`nb-input ${v.requestor?"err":""}`,value:r.requestor,onChange:n=>m({...r,requestor:n.target.value}),placeholder:"Full Name"})]}),e.jsxs("div",{className:"nb-field",children:[e.jsxs("label",{className:"nb-label",children:[e.jsx(c,{path:l.mail}),"Email address ",e.jsx("span",{className:"req",children:"*"})]}),e.jsx("input",{type:"email",className:`nb-input ${v.email?"err":""}`,value:r.email,onChange:n=>m({...r,email:n.target.value}),placeholder:"email@example.com"})]}),e.jsxs("div",{className:"nb-field",children:[e.jsxs("label",{className:"nb-label",children:[e.jsx(c,{path:l.phone}),"Contact number ",e.jsx("span",{className:"req",children:"*"})]}),e.jsx("input",{type:"tel",className:`nb-input ${v.phoneNumber?"err":""}`,value:r.phoneNumber,onChange:n=>{const a=n.target.value.replace(/\D/g,"").slice(0,11);m({...r,phoneNumber:a})},placeholder:"09XX XXX XXXX"})]})]})]})}),e.jsx("div",{className:"nb-footer-outer",children:e.jsxs("div",{className:"nb-footer",children:[e.jsxs("button",{type:"button",className:"nb-btn-back",onClick:ue,children:[e.jsx(c,{path:l.arrowLeft,size:15}),"Back"]}),f<4?e.jsxs("button",{type:"button",className:"nb-btn-next",onClick:be,children:["Next",e.jsx(c,{path:l.arrowRight,size:15})]}):e.jsxs("button",{type:"button",className:"nb-btn-next",onClick:me,children:["Submit",e.jsx(c,{path:l.arrowRight,size:15})]})]})})]})]})]})}export{Ee as default};
