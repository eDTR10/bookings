import{u as I,d as O,r as m,j as e,M as P,a as q,S as y}from"./index-97cab154.js";import{A as L}from"./arrow-left-c00d0404.js";import{E as B}from"./eye-4c3abe41.js";import{F}from"./file-text-36e6c140.js";import{D as U,C as M}from"./download-9576dd5a.js";import{C as V}from"./check-circle-2-1cd966d8.js";import{X as W}from"./x-circle-6cbff60b.js";const G="/bookings/dic.png",H="/bookings/bp.png",l=a=>String(a??"").replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;").replace(/'/g,"&#039;"),w=a=>{if(!a)return"—";const i=new Date(`${a}T00:00:00`);return Number.isNaN(i.getTime())?a:i.toLocaleDateString("en-US",{year:"numeric",month:"long",day:"numeric"})};function K(a,i,n){const h=i.length>0?i.map(b=>`
              <tr>
                <td>${l(b.kit_id||b.starlink_serial_number||"—")}</td>
                <td>${l(b.description||"Starlink Equipment")}</td>
                <td>${l(b.model_type||"Mini")}</td>
              </tr>
            `).join(""):`
          <tr>
        ...
        `,j=new Date().toLocaleDateString("en-US",{year:"numeric",month:"long",day:"numeric"});return`
<!DOCTYPE html>
<html lang="en">
<head>
<meta charset="UTF-8">
...
<div class="container">
  ...
  <div class="government-header">
    ...
    <div class="logo-wrapper">
      <img src="${H}" alt="Bagong Pilipinas Logo" />
    </div>
  ...
  <div class="document-title">
    ...
    <p>Submitted on ${l(j)}</p>
  </div>

  <div class="form-section">

    <div class="request-no-banner">
      REQUEST NO: ${l(n||"______________")}
    </div>
  ...
  <div class="form-value">
    ${a.reservation_end_date&&a.reservation_start_date!==a.reservation_end_date?`${l(w(a.reservation_start_date))} – ${l(w(a.reservation_end_date))}`:l(w(a.reservation_start_date))}
  </div>
</div>

      <div class="form-group">
        <span class="form-label">Expected Return Date:</span>
        <div class="form-value">${l(w(a.expected_return_date))}</div>
      </div>
