import{u as I,d as O,r as m,j as e,M as P,a as q,S as j}from"./index-d2918338.js";import{A as L}from"./arrow-left-941f6db4.js";import{E as B}from"./eye-e22f32cf.js";import{F}from"./file-text-bd6543f2.js";import{D as U,C as M}from"./download-3ab26b2b.js";import{C as V}from"./check-circle-2-d46448d4.js";import{X as W}from"./x-circle-30a125b1.js";const l=a=>String(a??"").replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;").replace(/'/g,"&#039;"),N=a=>{if(!a)return"—";const i=new Date(`${a}T00:00:00`);return Number.isNaN(i.getTime())?a:i.toLocaleDateString("en-US",{year:"numeric",month:"long",day:"numeric"})};function G(a,i,n){const h=i.length>0?i.map(b=>`
              <tr>
        ...
        `,w=new Date().toLocaleDateString("en-US",{year:"numeric",month:"long",day:"numeric"});return`
<!DOCTYPE html>
<html lang="en">
<head>
<meta charset="UTF-8">
  ...
  <div class="form-section">
    ...
    <div class="form-row">
      ...
      <div class="form-group">
        ...
        <div class="form-value">${l(N(a.reservation_start_date))}</div>
      </div>

      <div class="form-group">
        <span class="form-label">Date end of Activity:</span>
        <div class="form-value">${l(N(a.reservation_end_date))}</div>
      </div>

      <div class="form-group">
        <span class="form-label">Expected Return Date:</span>
        <div class="form-value">${l(N(a.expected_return_date))}</div>
      </div>
