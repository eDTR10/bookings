import{u as P,d as L,r as m,j as e,M as B,a as N,S as g}from"./index-0fc69e83.js";import{A as F}from"./arrow-left-f45dc864.js";import{E as U}from"./eye-b38ff569.js";import{T as M}from"./trash-2-a9de0ca6.js";import{F as V}from"./file-text-33e9cb74.js";import{D as W,C as G}from"./download-af1b0d2c.js";import{C as H}from"./check-circle-2-cfdc3b67.js";import{X as K}from"./x-circle-b1672c6b.js";const J="/bookings/dic.png",Y="/bookings/bp.png",o=a=>String(a??"").replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;").replace(/'/g,"&#039;"),j=a=>{if(!a)return"—";const l=new Date(`${a}T00:00:00`);return Number.isNaN(l.getTime())?a:l.toLocaleDateString("en-US",{year:"numeric",month:"long",day:"numeric"})};function Q(a,l,c){const h=l.length>0?l.map(b=>`
              <tr>
