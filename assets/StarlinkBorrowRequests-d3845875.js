import{u as q,r as c,j as e,M as S,a as y,S as k}from"./index-2b63eb1b.js";import{A}from"./arrow-left-7e47de3b.js";import{F as T}from"./file-text-dd63c318.js";import{D as z,C as P}from"./download-3ab3e88d.js";import{C as $}from"./check-circle-2-dfec1b99.js";import{X as L}from"./x-circle-3e4b5a88.js";const l=a=>String(a??"").replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;").replace(/'/g,"&#039;"),_=a=>{if(!a)return"—";const s=new Date(`${a}T00:00:00`);return Number.isNaN(s.getTime())?a:s.toLocaleDateString("en-US",{year:"numeric",month:"long",day:"numeric"})};function O(a,s,o){const f=s.length>0?s.map(t=>`
              <tr>
