import{u as P,d as L,r as m,j as e,M as B,a as N,S as g}from"./index-c7ffd172.js";import{A as F}from"./arrow-left-4882427b.js";import{E as U}from"./eye-885d6949.js";import{T as M}from"./trash-2-d2789cc0.js";import{F as V}from"./file-text-e0a7a5c8.js";import{D as W,C as G}from"./download-056b5178.js";import{C as H}from"./check-circle-2-a6d5e480.js";import{X as K}from"./x-circle-36fe6922.js";const J="/bookings/dic.png",Y="/bookings/bp.png",o=a=>String(a??"").replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;").replace(/'/g,"&#039;"),j=a=>{if(!a)return"—";const l=new Date(`${a}T00:00:00`);return Number.isNaN(l.getTime())?a:l.toLocaleDateString("en-US",{year:"numeric",month:"long",day:"numeric"})};function Q(a,l,c){const h=l.length>0?l.map(b=>`
              <tr>
