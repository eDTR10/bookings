import{u as q,r as c,j as e,M as S,a as y,S as k}from"./index-a19895d6.js";import{A}from"./arrow-left-0e459c6c.js";import{F as T}from"./file-text-e30690f2.js";import{D as z,C as P}from"./download-05e25a0a.js";import{C as $}from"./check-circle-2-4635e91a.js";import{X as L}from"./x-circle-3da02b41.js";const l=a=>String(a??"").replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;").replace(/'/g,"&#039;"),_=a=>{if(!a)return"—";const s=new Date(`${a}T00:00:00`);return Number.isNaN(s.getTime())?a:s.toLocaleDateString("en-US",{year:"numeric",month:"long",day:"numeric"})};function O(a,s,o){const f=s.length>0?s.map(t=>`
              <tr>
