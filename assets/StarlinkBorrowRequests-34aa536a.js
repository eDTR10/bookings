import{u as q,r as c,j as e,M as S,a as y,S as k}from"./index-d6995049.js";import{A}from"./arrow-left-de7d5ec6.js";import{F as T}from"./file-text-2587b5a0.js";import{D as z,C as P}from"./download-9a1e4c7e.js";import{C as $}from"./check-circle-2-711081df.js";import{X as L}from"./x-circle-1179e56a.js";const l=a=>String(a??"").replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;").replace(/'/g,"&#039;"),_=a=>{if(!a)return"—";const s=new Date(`${a}T00:00:00`);return Number.isNaN(s.getTime())?a:s.toLocaleDateString("en-US",{year:"numeric",month:"long",day:"numeric"})};function O(a,s,o){const f=s.length>0?s.map(t=>`
              <tr>
