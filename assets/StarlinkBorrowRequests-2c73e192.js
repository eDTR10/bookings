import{u as q,r as c,j as e,M as S,a as y,S as k}from"./index-5a92b7f0.js";import{A}from"./arrow-left-37b64d00.js";import{F as T}from"./file-text-b3783f7c.js";import{D as z,C as P}from"./download-6e08916d.js";import{C as $}from"./check-circle-2-d1b7e5ba.js";import{X as L}from"./x-circle-308a7f88.js";const l=a=>String(a??"").replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;").replace(/'/g,"&#039;"),_=a=>{if(!a)return"—";const s=new Date(`${a}T00:00:00`);return Number.isNaN(s.getTime())?a:s.toLocaleDateString("en-US",{year:"numeric",month:"long",day:"numeric"})};function O(a,s,o){const f=s.length>0?s.map(t=>`
              <tr>
