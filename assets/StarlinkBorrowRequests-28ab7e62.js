import{u as q,r as c,j as e,M as S,a as y,S as k}from"./index-f6d408af.js";import{A}from"./arrow-left-f9c7d657.js";import{F as T}from"./file-text-303f91b2.js";import{D as z,C as P}from"./download-d139aa33.js";import{C as $}from"./check-circle-2-8809874a.js";import{X as L}from"./x-circle-30b9425b.js";const l=a=>String(a??"").replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;").replace(/'/g,"&#039;"),_=a=>{if(!a)return"—";const s=new Date(`${a}T00:00:00`);return Number.isNaN(s.getTime())?a:s.toLocaleDateString("en-US",{year:"numeric",month:"long",day:"numeric"})};function O(a,s,o){const f=s.length>0?s.map(t=>`
              <tr>
