import{u as q,r as c,j as e,M as S,a as y,S as k}from"./index-2f17b667.js";import{A}from"./arrow-left-736c4a0d.js";import{F as T}from"./file-text-21350c64.js";import{D as z,C as P}from"./download-e2799789.js";import{C as $}from"./check-circle-2-b7e28dfe.js";import{X as L}from"./x-circle-c7367bce.js";const l=a=>String(a??"").replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;").replace(/'/g,"&#039;"),_=a=>{if(!a)return"—";const s=new Date(`${a}T00:00:00`);return Number.isNaN(s.getTime())?a:s.toLocaleDateString("en-US",{year:"numeric",month:"long",day:"numeric"})};function O(a,s,o){const f=s.length>0?s.map(t=>`
              <tr>
